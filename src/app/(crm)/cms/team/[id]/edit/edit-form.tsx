...
import { updateTeamMemberAction } from "@/app/actions/cms/team";
...
export function EditTeamMemberForm({ member }: { member: TeamMember }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <CmsMediaPicker name="photoId" label="Photo" defaultValue={member.photoId} />
